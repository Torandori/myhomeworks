...
function task1(){
  const num1 = document.getElementById('task_1_1').valueAsNumber;
  const num2 = document.getElementById('task_1_2').valueAsNumber;
  const result = compare(num1, num2);

  document.getElementById('task_1_result').innerText = `Smaller num is ${result}`;
}
